...
export interface WEEDLInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "allowance"
...
export interface WEEDL extends BaseContract {
  connect(runner?: ContractRunner | null): WEEDL;
  waitForDeployment(): Promise<this>;

  interface: WEEDLInterface;
